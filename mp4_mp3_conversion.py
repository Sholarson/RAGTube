...
# files = os.listdir('YouTube_videos') # if you have downloade youtube video one by one, not a playlist
...
try:
    for file in files:
        ...
        # subprocess.run(["ffmpeg", "-i", f"YouTube_videos/{file}", f"audio/{video_no}_{video_name}.mp3"]) # same here 'youtube_video'
